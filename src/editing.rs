...
//     import::Net,
//     shapes::{GeoRect, InLayer, Path, Poly, Rect},
//     ALPHA,
// };
...
//     shapes as lyon_shapes, Fill, FillOptions, FillRule, GeometryBuilder, Path as LyonPath,
//     ShapeBundle as LyonShapeBundle, Stroke, StrokeOptions,
// };

// use geo::{intersects::Intersects, translate::Translate};
...
impl Plugin for EditingPlugin {
    fn build(&self, app: &mut App) {
        ...
        //     Update,
        //     (
        //         cursor_hover_detect_system,
        //         initialize_pointer_event_determination,
        //         resolve_pointer_event_determination,
        //         set_hovered_system,
        //         select_clicked_system,
        //         spawn_despawn_selection_box_system,
        //         dragged_shape_initial_pos_system,
        //         click_and_drag_shape_system,
        //         highlight_hovered_system,
        //         highlight_selected_sytem,
        //         unhighlight_deselected_system,
        //         selection_box_selection_system,
        //         undo_redo_tracking_system,
        //         debug_undo_redo_system,
        //     ),
        // )
        // .add_systems(
        //     Update,
        //     (
        //         cycle_shape_stack_hover_system,
        //         print_hovered_info_system,
        //         print_selected_info_system,
        //         undo_redo_key_combo_system,
        //         undo_redo_system,
        //     ),
        // );
    }
...
//         let window = active_window_q.single();
...
//             if hit_test_path(&point, path.iter(), FillRule::NonZero, 0.00000001)
...
//     mut hovered_q: Query<(Entity, &mut Fill), Added<Hovered>>,
//     mut shape_q: Query<(Entity, &mut Fill), Without<Hovered>>,
//     selected_q: Query<Entity, With<Selected>>,
//     mut removed_hovered: RemovedComponents<Hovered>,
// ) {
//     'outer_1: for (hovered_e, mut fill) in hovered_q.iter_mut() {
//         for selected_e in selected_q.iter() {
//             if selected_e == hovered_e {
//                 continue 'outer_1;
//             }
//         }
//         fill.color = *fill.color.set_a(0.5);
//     }

//     'outer_2: for entity in removed_hovered.read() {
//         if let Ok((shape_e, mut fill)) = shape_q.get_mut(entity) {
//             for selected_e in selected_q.iter() {
//                 if selected_e == shape_e {
//                     continue 'outer_2;
//                 }
//             }
//             fill.color = *fill.color.set_a(ALPHA);
//         }
//     }
// }
...
//         *initial_world_pos =
//             screen_to_world_pos(&active_window_q, &camera_q, pointer_initial_pos.unwrap());
//         let transform =
//             Transform::from_translation(Vec3::new(initial_world_pos.x, initial_world_pos.y, 800.0));

//         let selection_box = LyonShapeBundle {
//             path: GeometryBuilder::build_as(&lyon_rect),
...
//             selection_box,
//             Fill::color(Color::rgba(1.0, 1.0, 1.0, 0.25)),
//             Stroke {
...
// pub fn highlight_selected_sytem(mut curr_selected_q: Query<&mut Fill, With<Selected>>) {
//     for mut fill in curr_selected_q.iter_mut() {
//         fill.color = *fill.color.set_a(0.75);
//     }
// }

// pub fn unhighlight_deselected_system(
//     query: Query<Entity>,
//     mut draw_q: Query<&mut Fill>,
//     mut deselected: RemovedComponents<Selected>,
// ) {
//     for entity in deselected.read() {
//         if let Ok(mut fill) = draw_q.get_mut(entity) {
...
// ) {
//     for ev in pre_drag_pos_ev.read() {
//         *initial_shape_pos = (vec![ev.entity], ev.pos);
//     }
//     for interaction in interaction_ev.read() {
//         match interaction {
...
// ) {
//     if keyboard.pressed(KeyCode::AltLeft) && keyboard.just_pressed(KeyCode::Z) {
